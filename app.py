...
# === NASSIM GUEST ACCOUNT ===
UID = "4656776663"
PASSWORD = "57F388071BB214B6ED99DD98D1D7C5C7D8B5D8E8008D0EE8B9B02196CA349604"
...
def home():
    return jsonify({
        ...
        "example": "/player-info?uid=14488125122"
    })
...
def refresh_tokens_endpoint():
    try:
        ...
        return jsonify({'message': 'Tokens refreshed for all regions.','developer': 'NASSIM'}), 200
    except Exception as e:
        return jsonify({'error': f'Refresh failed: {e}'}), 500

# === Startup ===
async def startup():
    print("🚀 NASSIM Free Fire API Starting...")
    print(f"📱 Using Guest Account: {UID}")
    await initialize_tokens()
    asyncio.create_task(refresh_tokens_periodically())
    print("✅ NASSIM API is ready!")
